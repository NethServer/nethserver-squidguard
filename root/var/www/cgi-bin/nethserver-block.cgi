...
while (new CGI::Fast)
{
   ...
   else 	# CT_HTML
   {
      ...
      {
        $forbidden = $Babel{Title};
        $title = "$Babel{Title} ($category)";
        $explanation_prefix = $Babel{Prefix};
        $explanation_suffix = $Babel{Suffix};
        $more_info = "$Babel{Info} <a target=\"blank\" href=\"https://www.urlfilterdb.com/blocking\">$Babel{Here}</a>.";
        ...
        else      	# no ads
        {
          ...
          else
          {
            ...
            print "<font class=\"title\" size=\"$titlesize\">$forbidden</font> <br>\n";
            print "<p><font size=\"$textsize\"></p>\n";
            print "$explanation_prefix <i class=\"category\">$category</i> $explanation_suffix <br>\n";
            print "<p>URL: <span class=\"url\">$url</span><p>\n";
            print "<p>\n";
            print "<p>\n";
            print "$more_info\n";
            print "<br>\n&nbsp;<p />\n";
